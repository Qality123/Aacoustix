      ...
      <div className="entity-header" style={{ background: 'linear-gradient(135deg, #111111, #000000)' }}>
        <div className="entity-header-content">
          <div className="entity-image flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.1)' }}>
            <Mic2 size={32} className="sm:w-[64px] sm:h-[64px] text-accent" />
          </div>
          <div>
            <p className="text-xs uppercase tracking-widest mb-2">Music</p>
            <h1 className="text-3xl sm:text-5xl font-bold mb-2">Artists</h1>
            <p className="text-text-secondary text-sm">All artists on Aacoustix</p>
          </div>
        </div>
      </div>
      <div className="pt-2">
